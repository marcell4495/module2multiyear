...
Sub tickerloop()
    'Setting up the stage
        ...
        'variable for holding the ticker name,column interest'
        Dim tickername As String
    
        'varable for holding a total count on the total volume of trade
        ...
        'Yearly Change is simply the difference: (Close Price at the end of a trading year - Open Price at the beginning of the trading year)
        'Percent change is a simple percent change ((Close - Open)/Open)*100
        Dim open_price As Double
        'Setting initial open_price. Other opening prices will be determined in the conditional loop.
        ...
        'Count of the number of rows in the first column'
        lastrow = Cells(Rows.Count, 1).End(xlUp).Row

        'Loop through the rows by the ticker names'
        'ticker names are sorted and are alpha-numeric/string variables'
